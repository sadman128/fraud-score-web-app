  ...
  const handleSearch = (e) => {
    ...
    if (searchQuery.trim()) {
      navigate(`/search?query=${encodeURIComponent(searchQuery)}`)
        setSearchQuery("") // clear after submit
    }
  }
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    {user?.username || "User"}
                      ...
                      <button
                          ...
                          className="p-2 text-gray-600 dark:text-gray-300 hover:text-danger-600 dark:hover:text-danger-400 transition-colors"
                          title="Logout"
                      >
                  ...
                  {isAuthenticated ? (
                    ...
                    {user?.username || "User"}
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-danger-600 dark:text-danger-400 hover:text-danger-700 dark:hover:text-danger-300 transition-colors"
                        >
                          <LogOut className="w-4 h-4" />
                          Logout
                        </button>
